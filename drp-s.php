...
<script>
    $(document).ready(function() {
        $('#tablePhaseS').DataTable( {
            ajax:           './sensing/_table-get-pltmh-s.php',
            deferRender:    true,
            scrollY:        200,
            scrollCollapse: true,
            scroller:       true,
                            ...
                            <div class="span12">
                                <div class="widget">
                                    ...
                                    <div class="widget-body">
                                        <table id="tablePhaseS" class="display" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>ID</th>
                                                    <th>Date</th>
                                ...
                                <div class="widget">
                                    ...
                                    <div class="widget-body">
                                        <form method="post" action="./sensing/_export-xls-s.php">
